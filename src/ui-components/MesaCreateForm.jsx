...
export default function MesaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setNroMesa(initialValues.nroMesa);
    setErrors({});
  };
  const validations = {
    nroMesa: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Mesa(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MesaCreateForm")}
      {...rest}
    >
      <TextField
        label="Nro mesa"
